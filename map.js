...
if(ggMap_xyz_9753.loadMap && locs_xyz_9753[0]) {
    var mapCenter = ggMap_xyz_9753.center || locs_xyz_9753[0].address;
    google.maps.event.addDomListener(window, 'load', initMap(mapCenter, ggMap_xyz_9753.zoom, locs_xyz_9753));
}